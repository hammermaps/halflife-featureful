...
// give the barrel particle its default values
...
{
	//damping
	sParticle.vVelocity.x *= ( 1 / ( 1 + fabsf(1.2f * flTimeSinceLastDraw * sParticle.vVelocity.x)));
	sParticle.vVelocity.y *= ( 1 / ( 1 + fabsf(1.2f * flTimeSinceLastDraw * sParticle.vVelocity.y)));
	sParticle.vVelocity.z *= ( 1 / ( 1 + fabsf(1.2f * flTimeSinceLastDraw * sParticle.vVelocity.z)));
...
// give the spark particle its default values
...
{
	//damping
	sParticle.vVelocity.x *= ( 1 / ( 1 + fabsf(0.5f * flTimeSinceLastDraw * sParticle.vVelocity.x)));
	sParticle.vVelocity.y *= ( 1 / ( 1 + fabsf(0.5f * flTimeSinceLastDraw * sParticle.vVelocity.y)));
	sParticle.vVelocity.z *= ( 1 / ( 1 + fabsf(0.5f * flTimeSinceLastDraw * sParticle.vVelocity.z)));
...
// give the white smoke particle its default values
